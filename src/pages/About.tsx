...
export function About() {
	return (
		<div className="w-[80%] md:w-[60%] absolute top-[80vh] pt-[20vh] left-1/2 -translate-x-1/2" id="about">
			<div className="w-full h-[400px] lg:flex">
				<div className="w-full lg:w-1/2">
					...
					<h4 className="font-sans text-base text-[#8992B1] w-full">
						Hello! My name is Sai and I enjoy creating things that live on the internet. My interest in web development started back in
						2017 when I decided to try building my own social media management platform — turns out hacking together a custom MVP taught
						me a lot about software engineering!{" "}
					</h4>
					<br />
					<h4 className="font-sans text-base text-[#8992B1] w-full">
						Fast-forward to today, and I’ve had the privilege of working at a medical based startup, edtech startup, open source projects
						and much more. My main focus these days is building accessible, inclusive products and digital experiences at{" "}
