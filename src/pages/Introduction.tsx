...
export default function Introduction() {
	return (
		<div className="w-[60%] min-h-[400px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
			...
			<h4 className="font-sans text-base text-[#8992B1] md:w-1/2 w-full">
				...
				interfaces for medical practice at <span className="text-primary">Onito.io.</span>
			</h4>
